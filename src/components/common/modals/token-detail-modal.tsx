...
const TokenDetailModal = ({ isOpen, setIsOpen }: TokenDetailModalProps) => {
  ...
  const TokenData = {
    ...
    website: "",
    about:
      "AetherDEX Token is the native governance token for the AetherDEX decentralized exchange, enabling users to participate in protocol governance and earn staking rewards.",
  };
    ...
    >
        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="text-xs text-muted-foreground">
              View detailed information about your AetherDEX Token holdings
              including price data, market statistics, and portfolio allocation.
            </div>
          </div>
        </div>
        <div
      ...
      <div className="w-full p-4 md:p-6  flex gap-6 flex-col">
        <div className="flex gap-6 w-full flex-col md:flex-row">
          <div className="border border-input px-6 py-3.5 flex flex-col gap-1 w-full">
            ...
            <div className="flex gap-1">
              ...
              <div
                className={`${
                  TokenData.status === "up" ? "text-green-600" : "text-red-600"
                } text-sm`}
              >
          ...
          <div className="border border-input px-6 py-3.5 flex flex-col gap-1 w-full">
            ...
            <div className="text-xl text-foreground font-semibold">
              ${TokenData.holdingAmount.toLocaleString("en-US")}{" "}
              {TokenData.symbol}
            </div>
            <div className="flex gap-1 text-muted-foreground text-sm">
              <div>Value:</div>
              <div>${TokenData.value.toLocaleString("en-US")}</div>
            </div>
          </div>
        </div>
          ...
          <ResponsiveContainer width="100%" height={150}>
            ...
            >
              ...
              <Area
                ...
                dataKey="price"
                stroke="#FB9B00"
                fill="url(#paint0_linear_843_9330)"
                fillOpacity={0.2}
              />
              <defs>
                <linearGradient
                  id="paint0_linear_843_9330"
                  x1="36.3071"
                  y1="98.25"
                  x2="129.633"
                  y2="-124.681"
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="text-xs text-muted-foreground">{TokenData.about}</div>
        </div>
