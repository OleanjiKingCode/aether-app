  ...
  return (
    <div className="bg-card border-[1px] border-input p-6 flex flex-col gap-5">
      ...
      <div className="relative">
        <TokenPanel title="From" isLoading={isLoading} />
        {mode === 'limit' && (
        ...
        <div className={`absolute ${mode === 'market' ? 'bottom-[-40.5px]' : 'bottom-[-70.5px]'} left-[calc(50%-22.5px)] bg-card border-[1px] border-input rounded-full p-2 flex justify-center items-center w-15 h-15`}>
      ...
      <div className={`${mode === 'market' ? '' : 'mt-16'}`}>
        <TokenPanel title="To" isLoading={isLoading} />
      </div>
        ...
        >
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              <div className="cursor-pointer w-10 h-7 border border-input bg-background flex items-center justify-center text-xs text-muted-foreground rounded">0.1%</div>
              <div className="cursor-pointer w-10 h-7 border border-input bg-background flex items-center justify-center text-xs text-muted-foreground rounded">0.5%</div>
              <div className="cursor-pointer w-10 h-7 border border-input bg-background flex items-center justify-center text-xs text-muted-foreground rounded">1%</div>
            </div>
          </div>
        </DetailAccordion>
      )}
