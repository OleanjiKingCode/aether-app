        ...
        <div className="">
            <BaseCard className={`pb-3.5 flex flex-col gap-2.5 !bg-background`}>
                <div className="flex justify-between gap-2.5">
                    <div className="flex justify-between w-full flex-col md:flex-row gap-6 mb-6 md:mb-0">
                        <div className="flex gap-1.5 items-center">
                            <div className="">
                                <Image src={SwapPrivacyIcon} width={20} height={20} alt="" />
                            </div>
                ...
                <div className="flex flex-col gap-3">
                    <div className="text-xs text-muted-foreground">Analyzed 3 routes across 8 DEXs and 4 bridges:</div>
                </div>
                <div>
                    <BaseCard className={`bg-transparent px-3 py-2.5 ${aiRoutes[0].isRecommended ? '!border-primary !bg-[#BB3EFF33]' : ''}`}>
                    ...
                    <div className="flex flex-col gap-2.5 mb-2.5">
                        ...
                        <div className="flex flex-col gap-3">
                            {aiRoutes.map((row, index) => {
                                return (
                                    <BaseCard key={index} className={`bg-transparent px-3 py-2.5 ${row.isRecommended ? 'hidden' : ''}`}>
                                        <div className="flex justify-between gap-3">
                                            <div className="flex flex-col gap-2">
                                                <div className="flex flex-col md:flex-row gap-2">
                                                    <div className="text-sm text-muted-foreground">
