...
const DetailAccordion = ({ title, icon, children, className, isLoading }: DetailAccordionProps) => {
            ...
            <div className="flex justify-between">
                <div className="flex gap-1.5 items-center">
                    <div className="">
                        ...
                        {!isLoading && <Image src={icon} width={20} height={20} alt="" />}
                    </div>
                ...
                <div className={`flex items-center justify-center h-[24px] w-[24px] transition-transform duration-300 origin-center ${isShow ? "rotate-180" : "rotate-0"}`} onClick={showDetail}>
