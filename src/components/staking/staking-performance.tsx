                ...
                {!isLoading && (
                    <ResponsiveContainer width="100%" height={width > 500 ? 330 : 106}>
                        ...
                        >
                            ...
                            <Area type="monotone" dataKey="price" stroke="#BB3EFF" fill="url(#paint0_linear_1240_12791)" fillOpacity={0.2} />

                            <defs>
                                <linearGradient id="paint0_linear_1240_12791" x1="337" y1="-71.6575" x2="355.03" y2="287.621" gradientUnits="userSpaceOnUse">
