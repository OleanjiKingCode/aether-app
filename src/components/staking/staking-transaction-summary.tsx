  ...
  return (
    <div className="border border-input bg-background p-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between">
          <div className="text-muted-foreground text-sm">You will stake:</div>
          <div className="text-secondary text-sm font-semibold">0 AETH</div>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <div className="text-green-600 text-sm font-semibold">0.00 AETH</div>
        </div>
        <div className="flex justify-between">
          <div className="text-muted-foreground text-sm">
            Est. annual rewards:
        ...
        <div className="flex justify-between">
          <div className="text-muted-foreground text-sm">Withdraw time:</div>
          <div className="text-secondary text-sm font-semibold">-- days</div>
        </div>
      </div>
      <Divider />
      <div className="flex flex-col gap-2">
        <div className="flex justify-between">
          <div className="text-muted-foreground text-sm">Network fee:</div>
          <div className="text-secondary text-sm font-semibold">--</div>
        </div>
      </div>
    </div>
  );
