    ...
    return (
        <BaseCard className="flex gap-5 p-6 w-full xl:w-[450px] flex-col h-fit">
            <div className="flex gap-1.5 items-center">
                ...
                <div className="text-base text-foreground font-semibold">Reward tracker</div>
            </div>
            <div className="flex flex-col gap-3 w-full items-center justify-center">
                <Image src={GiftIcon} width={32} height={32} alt="" />
                <div className="text-xs text-muted-foreground font-medium">Claimable Rewards</div>
            ...
            <div className="h-[230px] border border-input">
                <div className="p-4 text-muted-foreground text-sm font-semibold">Reward Growth</div>
                <ResponsiveContainer width="100%" height="80%">
                    ...
                    >
                        <Area type="monotone" dataKey="price" stroke="#00A63E" fill="#052E16" />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
        </BaseCard>
