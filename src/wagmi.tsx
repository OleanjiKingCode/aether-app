...
import { ChainType, EVM, config as LIFIConfig, createConfig, getChains } from '@lifi/sdk';
    ...
    wallets: [
        {
            ...
            wallets: [injectedWallet, metaMaskWallet, walletConnectWallet, braveWallet, phantomWallet],
        }
    ],
    chains: [
        bsc,
...
const WagmiConfigWrapper: FC<PropsWithChildren> = ({ children }) => {
    ...
    const { data: chains } = useQuery({
        ...
        queryFn: async () => {
            ...
            (configLIFI as any).setChains(chains);
            return chains;
        },
    });
